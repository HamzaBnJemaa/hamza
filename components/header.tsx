    ...
    <header className="relative z-50 flex items-center justify-between p-6">
      ...
      <div className="flex items-center justify-between w-full md:hidden">
        ...
        <div className="relative flex items-center group" style={{ filter: "url(#gooey-filter)" }}>
          <button className="absolute right-0 px-3 py-2 rounded-full bg-white text-black font-normal text-sm transition-all duration-300 hover:bg-white/90 cursor-pointer h-9 flex items-center justify-center -translate-x-8 group-hover:-translate-x-14 z-0">
          ...
          <a 
            ...
            className="px-6 h-9 rounded-full bg-white text-black font-normal text-sm transition-all duration-300 hover:bg-white/90 cursor-pointer flex items-center z-10"
          >
